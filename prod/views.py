...
def home(request):
    ...
    return render(request, 'prod/home.html',{'form':form})
...
def add_product(request):
    ...
    return render(request, 'prod/add_p.html',{'form':form})        
...
def add_category(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('home')
    return render(request, 'prod/add_cat.html',{'form':form})        
...
def add_sale(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            return redirect('home')
    return render(request, 'prod/add_sale.html',{'form':form})  
def add_staff(request):
    ...
    return render(request, 'prod/add_staff.html', {'form': form})
...
def list_staff(request):
    ...
    return render(request, 'prod/staff_list.html', {'staff_members': staff_members,'salary':salary})    
...
def staff_detail(request, staff_id):
    ...
    return render(request, 'prod/staff_detail.html', {'total_attendance_days':total_attendance_days,'staff': staff, 'total_absent_days': total_absent_days, 'sales':sales})
...
def plot_cumulative_sales(request):
    ...
    return render(request, 'prod/plot.html', context)
...
def view_attendance(request):
    ...
    return render(request, 'prod/view_attendance.html', {'today_attendance': today_attendance})
...
def credit_list(request):
    ...
    return render(request, 'prod/credit_list.html', {'loans_with_credit': loans_with_credit,'credits':credits})
...
def update_sale(request, pk):
    ...
    return render(request, 'prod/update_sale.html', {'form': form, 'sale': sale})
...
def update_credit(request, pk):
    ...
    return render(request, 'prod/update_credit.html', {'form': form, 'credits': credits})
from django.shortcuts import render, redirect
...
def add_payment(request, credit_id):
    ...
    return render(request, 'prod/add_payment.html', {'form': form, 'credit': credit})
...
def create_salary(request):
    if request.method == 'POST':
        ...
        form = SalaryForm()
    return render(request, 'prod/create_update.html', {'form': form})
def create_salpay(request):
    ...
    return render(request, 'prod/salary_pay.html', {'form': form})
...
def Salary_Pay(request, salary_id):
    ...
    return render(request, 'prod/salary_pay.html', {'form': form, 'salary': salary})
...
def salary_list(request):
    ...
    return render(request, 'prod/salary_list.html', {'salaries': salaries})

def boss_expense_list(request):
    boss_expenses = BossExpense.objects.all()
    return render(request, 'prod/boss_ex.html', {'boss_expenses': boss_expenses})
...
def credit_detail(request,credit_id):
    ...
    return render(request,'prod/c_detail.html',{'c_detail':c_detail})
...
def search_view(request):
    ...
    if query:
        ...
        return render(request, 'prod/search.html', context)
    else:
        return render(request, 'prod/search_form.html')
...
def credit_payments_view(request, credit_id):
    ...
    return render(request, 'prod/crd_detail.html', context)